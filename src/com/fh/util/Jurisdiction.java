...
public class Jurisdiction {
	...
	public static String getUsername(){
		Object userNameObj=getSession().getAttribute(Const.SESSION_USERNAME);
		return null==userNameObj?null:userNameObj.toString();
	}
