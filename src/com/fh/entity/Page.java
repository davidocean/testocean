	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			if(currentPage==1){
				...
				sb.append("	<li><input type=\"number\" value=\"\" id=\"toGoPage\" style=\"width:52px;text-align:center;float:left\" placeholder=\"页码\"/></li>\n");
			...
			sb.append("	<option value='10' "+(showCount==10?"selected='selected'":"")+">10</option>\n");
			sb.append("	<option value='20' "+(showCount==20?"selected='selected'":"")+">20</option>\n");
			sb.append("	<option value='30' "+(showCount==30?"selected='selected'":"")+">30</option>\n");
			sb.append("	<option value='40' "+(showCount==40?"selected='selected'":"")+">40</option>\n");
			sb.append("	<option value='50' "+(showCount==50?"selected='selected'":"")+">50</option>\n");
			sb.append("	<option value='60' "+(showCount==60?"selected='selected'":"")+">60</option>\n");
			sb.append("	<option value='70' "+(showCount==70?"selected='selected'":"")+">70</option>\n");
			sb.append("	<option value='80' "+(showCount==80?"selected='selected'":"")+">80</option>\n");
			sb.append("	<option value='90' "+(showCount==90?"selected='selected'":"")+">90</option>\n");
			sb.append("	<option value='99' "+(showCount==99?"selected='selected'":"")+">99</option>\n");
			sb.append("	</select>\n");
			sb.append("	</li>\n");
